...
public class ForecastFragment extends Fragment {
    ...
    /**
     * TODO: move the network snipping code here
     */
    ...
    private class FetchWeatherTask extends AsyncTask<String, Integer, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                String apiKey = "&APPID=" + "2022d3648d3b82ba04845a92ed3d85eb";
                ...
                Uri theUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                ...
                Log.v(LOG_TAG, "adbBuilt URI" + theUrl.toString());
                ...
                Log.d("MyApp", "I am here testing");
                System.out.println("this is the test for this forecastJsonStr " + forecastJsonStr);

             weatherDataFromJson = getWeatherDataFromJson(forecastJsonStr,numofDays);

            } catch (IOException e) {
                Log.e(LOG_TAG, "Error ", e);
                // If the code didn't successudo sfully get the weather data, there's no point in attemping
                // to parse it.
                return null;
